...
- Ã¢ÂÂ¡ **Vite** - Fast build tool and development server
- Ã¢ÂÂÃ¯Â¸Â **React 18** - Modern React with hooks
- Ã°ÂÂÂ· **TypeScript** - Type-safe JavaScript
- Ã°ÂÂÂ¨ **Tailwind CSS** - Utility-first CSS framework
- Ã°ÂÂÂ¤ **Bayer Sans** - Complete font system from Bayer CDN
...
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ bayer-sans.ts      # Font utility library
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ App.tsx                # Main application component
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ index.css              # Global styles with font definitions
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ main.tsx               # React entry point
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ vite-env.d.ts         # Vite type definitions
